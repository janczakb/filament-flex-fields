<div class="fff-playground-skeleton-demo">
    ...
    <p class="fff-playground-skeleton-demo__text">
        ...
        Use the steps below to force a visible ~0.3s shimmer (playground-only).
    </p>
    <ol class="fff-playground-skeleton-demo__steps">
        ...
        <li>Skeleton should disappear after ~0.3s and show the form fields (same injector behavior in modal and slide-over).</li>
    </ol>
