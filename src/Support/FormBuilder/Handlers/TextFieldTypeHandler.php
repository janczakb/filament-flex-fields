...
final class TextFieldTypeHandler extends AbstractFieldTypeHandler
{
    ...
    public function make(FlexFieldDefinition $definition, string $statePath): Component
    {
        ...
        return match ($definition->type) {
            ...
            FieldType::Email => $this->flexTextInput->configure(FlexTextInput::make($statePath)->email(), $config),
            FieldType::Url => $this->flexTextInput->configure(FlexTextInput::make($statePath)->url(), $config),
