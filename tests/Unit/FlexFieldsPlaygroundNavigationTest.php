...
it('exposes one registry entry per playground component', function () {
    ...
    expect(count(FlexFieldsPlaygroundRegistry::definitions()))->toBe(55)
        ->and(count(FlexFieldsPlaygroundRegistry::pageConfigurations()))->toBe(55);
});
